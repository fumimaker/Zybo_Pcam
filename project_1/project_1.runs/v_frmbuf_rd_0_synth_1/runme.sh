...
HD_PWD='Z:/GitHub/Zybo_Pcam/project_1/project_1.runs/v_frmbuf_rd_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_frmbuf_rd_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_frmbuf_rd_0.tcl
