...
#
# Generated by export_simulation on Thu Oct 24 19:48:55 +0900 2019
#
################################################################################
...
'-reset_run' switch to the './v_frmbuf_rd_0.sh' script.

./v_frmbuf_rd_0.sh -reset_run
...
./v_frmbuf_rd_0.sh -noclean_files

For more information on the script, please type './v_frmbuf_rd_0.sh -help'.
