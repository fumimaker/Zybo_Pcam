...
public:
	...
	*/
	...
	Errc set_mode(OV5640_cfg::mode_t mode)
	{
		...
		writeReg(0x0103, 0x00); //software reset[0]=0
		*/
...
private:
	...
	uint8_t dev_address_ = (0x36);
	uint8_t dev_address2_ = (0x46 >> 1); //what is this?
