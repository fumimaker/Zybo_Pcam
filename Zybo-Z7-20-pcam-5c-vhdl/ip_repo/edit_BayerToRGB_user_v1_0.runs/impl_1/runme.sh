...
HD_PWD='c:/github/zybo_pcam/zybo-z7-20-pcam-5c-vhdl/ip_repo/edit_BayerToRGB_user_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AXI_BayerToRGB_1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_AXI_BayerToRGB_1_0.tcl -notrace
