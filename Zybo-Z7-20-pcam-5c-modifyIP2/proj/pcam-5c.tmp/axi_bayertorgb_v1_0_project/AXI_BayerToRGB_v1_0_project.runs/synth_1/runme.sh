...
HD_PWD='c:/github/zybo_pcam/zybo-z7-20-pcam-5c-modifyip2/proj/pcam-5c.tmp/axi_bayertorgb_v1_0_project/AXI_BayerToRGB_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_BayerToRGB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_BayerToRGB.tcl
