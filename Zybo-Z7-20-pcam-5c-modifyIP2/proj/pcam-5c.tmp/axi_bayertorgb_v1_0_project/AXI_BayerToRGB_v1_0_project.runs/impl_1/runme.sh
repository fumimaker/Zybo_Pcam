...
HD_PWD='C:/Users/fpga/Documents/Github/Zybo_Pcam/Zybo-Z7-20-pcam-5c-modifyIP2/proj/pcam-5c.tmp/axi_bayertorgb_v1_0_project/AXI_BayerToRGB_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_BayerToRGB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_BayerToRGB.tcl -notrace
