...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  port (
    m_axis_video_tdata : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  signal \^m_axis_video_tdata\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \sAXIMasterGreen[9]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sCntColumns[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sCntColumns[2]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \sCntColumns[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \sCntColumns[7]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \sCntRemPixels[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sCntRemPixels[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sStrobesShiftReg[0][FirstColumn]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sStrobesShiftReg[0][Last]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of s_axis_video_tready_INST_0 : label is "soft_lutpair3";
begin
  m_axis_video_tdata(3 downto 0) <= \^m_axis_video_tdata\(3 downto 0);
...
\sStrobesShiftReg[0][Last]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => m_axis_video_tready,
      I4 => \sStrobesShiftReg[0][Last]_i_3_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m_axis_video_tdata\ : STD_LOGIC_VECTOR ( 27 downto 9 );
...
begin
  ...
  led(3 downto 0) <= \^button\(3 downto 0);
  m_axis_video_tdata(31) <= \<const0>\;
  m_axis_video_tdata(30) <= \<const0>\;
  m_axis_video_tdata(29) <= \^m_axis_video_tdata\(19);
  m_axis_video_tdata(28) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(27) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(26) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(25) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(24) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(23) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(22) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(21) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(20) <= \^m_axis_video_tdata\(27);
  m_axis_video_tdata(19) <= \^m_axis_video_tdata\(19);
  m_axis_video_tdata(18) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(17) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(16) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(15) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(14) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(13) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(12) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(11) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(10) <= \^m_axis_video_tdata\(17);
  m_axis_video_tdata(9) <= \^m_axis_video_tdata\(9);
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB
     port map (
      StreamClk => StreamClk,
      m_axis_video_tdata(3) => \^m_axis_video_tdata\(19),
      m_axis_video_tdata(2) => \^m_axis_video_tdata\(27),
      m_axis_video_tdata(1) => \^m_axis_video_tdata\(17),
      m_axis_video_tdata(0) => \^m_axis_video_tdata\(9),
