...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sAXIMasterBlue[8]_i_4\ : label is "soft_lutpair19";
...
\sAXIMasterBlue[8]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
