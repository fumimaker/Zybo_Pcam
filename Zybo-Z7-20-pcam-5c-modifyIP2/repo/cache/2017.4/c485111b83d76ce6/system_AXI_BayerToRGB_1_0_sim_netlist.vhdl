...
begin
  m_axis_video_tdata(0) <= 'Z';
  m_axis_video_tdata(1) <= 'Z';
  m_axis_video_tdata(2) <= 'Z';
  m_axis_video_tdata(3) <= 'Z';
  m_axis_video_tdata(4) <= 'Z';
  m_axis_video_tdata(5) <= 'Z';
  m_axis_video_tdata(6) <= 'Z';
  m_axis_video_tdata(7) <= 'Z';
  m_axis_video_tdata(8) <= 'Z';
  m_axis_video_tdata(9) <= 'Z';
  m_axis_video_tdata(10) <= 'Z';
  m_axis_video_tdata(11) <= 'Z';
  m_axis_video_tdata(12) <= 'Z';
  m_axis_video_tdata(13) <= 'Z';
  m_axis_video_tdata(14) <= 'Z';
  m_axis_video_tdata(15) <= 'Z';
  m_axis_video_tdata(16) <= 'Z';
  m_axis_video_tdata(17) <= 'Z';
  m_axis_video_tdata(18) <= 'Z';
  m_axis_video_tdata(19) <= 'Z';
  m_axis_video_tdata(20) <= 'Z';
  m_axis_video_tdata(21) <= 'Z';
  m_axis_video_tdata(22) <= 'Z';
  m_axis_video_tdata(23) <= 'Z';
  m_axis_video_tdata(24) <= 'Z';
  m_axis_video_tdata(25) <= 'Z';
  m_axis_video_tdata(26) <= 'Z';
  m_axis_video_tdata(27) <= 'Z';
  m_axis_video_tdata(28) <= 'Z';
  m_axis_video_tdata(29) <= 'Z';
  m_axis_video_tdata(30) <= 'Z';
  m_axis_video_tdata(31) <= 'Z';
