...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sAXIMasterBlue[9]_i_3\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \sOtherPixelsData[10]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \sOtherPixelsData[11]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \sOtherPixelsData[7]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \sOtherPixelsData[8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \sOtherPixelsData[9]_i_1\ : label is "soft_lutpair15";
...
\sAXIMasterBlue[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \sPixel_reg_n_0_[1][9]\,
      I5 => \sPixel_reg_n_0_[0][9]\,
      O => \sAXIMasterBlue[9]_i_2_n_0\
    );
\sAXIMasterBlue[9]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
...
\sAXIMasterGreen[10]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
