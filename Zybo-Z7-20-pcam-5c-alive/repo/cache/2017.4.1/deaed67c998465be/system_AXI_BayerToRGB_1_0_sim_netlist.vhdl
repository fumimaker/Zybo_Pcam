...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  ...
  signal jb_p_INST_0_i_1_n_0 : STD_LOGIC;
  signal jb_p_INST_0_i_2_n_0 : STD_LOGIC;
...
jb_p_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => counter_reg(12),
      I4 => counter_reg(15),
      I5 => jb_p_INST_0_i_1_n_0,
      O => jb_p
    );
jb_p_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAAAAA8"
    )
        port map (
      I0 => counter_reg(10),
      I1 => jb_p_INST_0_i_2_n_0,
      I2 => counter_reg(1),
      I3 => counter_reg(0),
      I4 => counter_reg(3),
      I5 => counter_reg(4),
      O => jb_p_INST_0_i_1_n_0
    );
jb_p_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
